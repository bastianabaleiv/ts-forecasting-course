...
En la [Clase 1](/_site/posts/clase-01) describimos al análisis exploratorio como uno de los objetivos
...
Revisemos las ACF de las series de tiempo vistas la [clase pasada](/_site/posts/clase-01):
...
El grado de suavidad de las series de tiempo revisadas en la [clase pasada](/_site/posts/clase-01/index.html#introST) es una de las características
...
+ *Sobreajustare* (*over-fit*) un modelo a los datos es tan malo como fallar en
...
elaboración de otra métrica porcentual llamada sMAPE (*symmetric MAPE*), usando
